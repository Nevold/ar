  ...
  document.body.addEventListener('click', async event => {
    ...
    switch (true) {
      case element.classList.contains('start-icon'): {
        ...
        (startButton.nextElementSibling as HTMLButtonElement).classList.add('active-icon');
        (startButton.nextElementSibling as HTMLButtonElement).disabled = false;
      ...
      case element.classList.contains('stop-icon'): {
        ...
        (stopButton.previousElementSibling as HTMLButtonElement).classList.add('active-icon');
        (stopButton.previousElementSibling as HTMLButtonElement).disabled = false;
        disabledRaceButton(element);
        break;
      }
